            ...
            <header className="relative h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden">
                ...
                <div className="max-w-4xl w-full relative z-10">
                    ...
                    <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-10">
                        Harnessing collective intelligence and AI-driven insights for real-time crisis response and decision-making.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
                        <a href="#features" className="px-8 py-4 bg-gradient-to-r from-red-600 to-red-500 text-white text-lg font-semibold rounded-lg shadow-lg transition-all duration-300 hover:from-red-500 hover:to-red-400 hover:shadow-xl hover:scale-[1.02] flex items-center justify-center">
                            Explore Features <FiArrowRight className="ml-2" />
                        </a>
                        <a href="#contact" className="px-8 py-4 border-2 border-red-500 text-white text-lg font-semibold rounded-lg transition-all duration-300 hover:bg-red-500/10 hover:shadow-lg flex items-center justify-center">
                            Contact Us
                        </a>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        <div className="lg:w-1/2">
                            <h2 className="text-4xl md:text-5xl font-bold mb-8">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-300">Our Mission</span>
                            </h2>
                            <p className="text-xl text-gray-300 leading-relaxed mb-6">
                                At Swift Sage, we're revolutionizing crisis management through innovative technology and community collaboration.
                            </p>
                            <p className="text-lg text-gray-400 leading-relaxed mb-8">
                                Our platform integrates real-time data collection, AI-powered analytics, and crowdsourced intelligence to provide actionable insights during critical situations.
                            </p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                ...
                                <div className="w-14 h-14 mb-6 rounded-xl bg-gradient-to-br from-${feature.color}-500/20 to-${feature.color}-500/10 flex items-center justify-center">
                                    {feature.icon}
                                </div>
            ...
            <section id="contact" className="py-24 px-6 bg-gray-900">
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col lg:flex-row gap-16">
                        <div className="lg:w-1/2">
                            <h2 className="text-4xl md:text-5xl font-bold mb-8">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-300">Get In Touch</span>
                            </h2>
                            <p className="text-xl text-gray-300 mb-8">
                                Have questions about our platform or interested in a demo? Our team is ready to assist you.
                            </p>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-6 md:mb-0">
                            <h3 className="text-2xl font-bold">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-300">Swift Sage</span>
                            </h3>
