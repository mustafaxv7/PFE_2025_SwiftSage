...
const LandingPage = () => {
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen flex flex-col overflow-hidden">
            <Navbar />
            <header className="relative h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full opacity-20">
                    <div className="absolute top-20 left-10 w-24 sm:w-40 h-24 sm:h-40 bg-red-500 rounded-full filter blur-3xl opacity-30 animate-pulse"></div>
                    <div className="absolute bottom-10 right-10 w-32 sm:w-60 h-32 sm:h-60 bg-blue-500 rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-4 sm:mb-6">
                                At Swift Sage, we're revolutionizing crisis management through
                            ...
                            <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-6 sm:mb-8">
                                Our platform integrates real-time data collection, AI-powered
                                analytics, and crowdsourced intelligence to provide actionable
                                    ...
                                    <div className="p-4 sm:p-6">
                                        <div className="bg-gray-800 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                                            <div className="flex items-center mb-1 sm:mb-2">
                                                <div className="w-6 sm:w-8 h-6 sm:h-8 bg-red-500/20 rounded-full flex items-center justify-center mr-2 sm:mr-3">
                                                    <FiAlertTriangle
                                        ...
                                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                            <div className="bg-gray-800 rounded-lg p-3 sm:p-4">
                                                <div className="w-8 sm:w-10 h-8 sm:h-10 bg-blue-500/20 rounded-full flex items-center justify-center mb-2 sm:mb-3">
                                                    <FiUsers
                                            ...
                                            <div className="bg-gray-800 rounded-lg p-3 sm:p-4">
                                                <div className="w-8 sm:w-10 h-8 sm:h-10 bg-purple-500/20 rounded-full flex items-center justify-center mb-2 sm:mb-3">
                                                    <FiBarChart2
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-10 sm:mb-16">
                        ...
                        <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                            Designed for efficiency, accuracy, and rapid response in critical
                            situations
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                icon: (
                                    <FiAlertTriangle className="text-2xl sm:text-3xl text-red-500" />
                                ),
                                color: 'red',
                            },
                            {
                            ...
                            },
                            {
                                ...
                                icon: (
                                    <FiBarChart2 className="text-2xl sm:text-3xl text-purple-500" />
                                ),
                                color: 'purple',
                            },
                        ].map((feature, index) => (
                            ...
                            >
                                ...
                                <div className="w-12 h-12 sm:w-14 sm:h-14 mb-4 sm:mb-6 rounded-xl bg-gradient-to-br from-${feature.color}-500/20 to-${feature.color}-500/10 flex items-center justify-center">
                                    {feature.icon}
                                </div>
            ...
            <section className="py-14 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-gray-900 to-gray-800">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-base sm:text-xl text-gray-300 mb-6 sm:mb-10 max-w-3xl mx-auto">
                        Join organizations worldwide who trust Swift Sage for their critical
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 sm:gap-16">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8">
                                Have questions about our platform or interested in a demo? Our team
                                is ready to assist you.
                            </p>
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-500/10 rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                                        <svg
                            ...
                            <form className="bg-gray-800/50 rounded-xl p-6 sm:p-8 shadow-lg border border-gray-700">
                                ...
                                <div className="space-y-4 sm:space-y-5">
                                    <div>
                                        <label
                                            htmlFor="name"
                                            className="block text-gray-300 mb-1 sm:mb-2 text-sm sm:text-base"
                                        >
                                            Your Name
                                        </label>
                                        <input
